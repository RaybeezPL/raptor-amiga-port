...
/* Raptor Amiga port: standalone preamble replacing the DOSBox build
 * environment headers (adlib.h/dosbox.h).  Only the DBOPL::Chip core is
 * used; the DOSBox mixer glue (DBOPL::Handler) has been removed. */
#ifndef DBOPL_H
#define DBOPL_H
