...
/* Raptor Amiga port: standalone build (DOSBox mixer glue removed).
 * LOG_MSG is only used for a debug print in table generation. */
#ifndef LOG_MSG
...
}		//Namespace DBOPL (Raptor Amiga: DOSBox mixer glue removed)
